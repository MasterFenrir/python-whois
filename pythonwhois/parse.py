...
registrant_fallback_regexes = {
    ...
    "postalcode": "Registrant[ \t\S]*Postal Code:(?P<postal>.*)",
...
admin_fallback_regexes = {
    ...
    "postalcode": "Admin[ \t\S]*Postal Code:(?P<postal>.*)",
...
billing_fallback_regexes = {
    ...
    "postalcode": "Billing[ \t\S]*Postal Code:(?P<postal>.*)",
...
tech_fallback_regexes = {
    ...
    "postalcode": "Tech[ \t\S]*Postal Code:(?P<postal>.*)",
